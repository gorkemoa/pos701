...
class Product {
  ...
  @override
  String toString() {
    return 'Product(postID: $postID, proID: $proID, catID: $catID, proName: $proName, proUnit: $proUnit, proStock: $proStock, proPrice: $proPrice, proNote: $proNote, isMenu: $isMenu)';
  }
} 